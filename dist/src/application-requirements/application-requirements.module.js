...
exports.ApplicationRequirementsModule = ApplicationRequirementsModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: application_requirements_schema_1.ApplicationRequirements.name, schema: application_requirements_schema_1.ApplicationRequirementsSchema }]),
        ],
